...
<head>
  ...
  <meta name="description" content="Progetto SociaLorem">
  <title>SociaLorem</title>
...
<body>
  ...
  <div class="container">
    <main class="box uno">
      <h1 class="title" id="longtitle">SociaLorem</h1>
    ...
    <figure class="box due">
      <img src="assets/telefono.png" alt="Telefono immagine" title="Immagine social"
        draggable="false">
      </figure>
