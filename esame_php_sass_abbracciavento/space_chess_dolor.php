...
<head>
  ...
  <meta name="description" content="Progetto Space Chess Dolor">
  <title>Space Chess Dolor</title>
...
<body>
  ...
  <div class="container">
    <main class="box uno">
      <h1 class="title">Space Chess Dolor</h1>
    ...
    <figure class="box due">
      <img src="assets/scacchispaziali.png" alt="Scacchi immagine" title="Immagine scacchi" draggable="false">
    </figure>
    ...
    <aside class="box tre">
      ...
      <ul>
        ...
        <li><a href="Lorem_cripto_dolor.php" title="Pagina Lorem Cripto Dolor">Lorem Cripto Dolor</a></li>
      </ul>
